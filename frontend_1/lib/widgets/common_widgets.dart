...
/// Error Display Widget - Shows error with retry button
...
/// Info Card Widget - Displays key-value information
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            ...data.map((entry) => _buildRow(entry.key, entry.value)).toList(),
          ],
        ),
      ),
    );
